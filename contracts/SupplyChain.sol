...
contract SupplyChain {
  ...
  function buyItem(uint sku) public payable forSale(sku) {
    require(msg.value >= items[sku].price, "Insufficient amount paid");
  ...
  function shipItem(uint sku) public sold(sku){
    require(msg.sender == items[sku].seller, "Not authorized.");
  ...
  function receiveItem(uint sku) public shipped(sku){
    require(msg.sender == items[sku].buyer, "Not authorized");
